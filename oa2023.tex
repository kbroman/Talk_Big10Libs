...
\end{minipage}
  ...
  \note{
      In thinking about Open Scholarship, I'm generally thinking of three
      things: open access publications, open source software, and open
      science (by which I mean open data, methods, and materials).
