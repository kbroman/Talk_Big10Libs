...
\frame{
  ...
  \note{
    ...
    Academic Alliance libraries, on 10 Jan 2023.
...
\item Associate Editor at \emph{Journal of the American Statistical
Association}
...
\begin{frame}[c]{}
  ...
  \note{
    For more about this paper, see my twitter thread on 10
...
\only<1|handout 0>{ \figw{Figs/timeline1.pdf}{1.0} }
\only<2|handout 0>{ \figw{Figs/timeline2.pdf}{1.0} }
\only<3|handout 0>{ \figw{Figs/timeline3.pdf}{1.0} }
\only<4|handout 0>{ \figw{Figs/timeline4.pdf}{1.0} }
\only<5|handout 0>{ \figw{Figs/timeline5.pdf}{1.0} }
\only<6>{ \figw{Figs/timeline.pdf}{1.0} }
...
\item How to persuade researchers to care?
  ...
  \vspace{30mm}
  \hfill
  {\footnotesize \lolit slides: \href{https://bit.ly/broman2023}{\tt \lolit bit.ly/broman2023}
  }
